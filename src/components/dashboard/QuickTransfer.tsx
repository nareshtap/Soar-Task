            ...
            <div className="mt-4 flex justify-between items-center gap-4">
                ...
                <div className='flex flex-row relative'>
                    ...
                    <input
                        ...
                        className="border outline-none w-full rounded-full p-2 bg-[#EDF1F7]"
                    />
                    <button
                        onClick={handleSend}
                        className=" bg-black flex gap-2 rounded-full h-full items-center  text-white px-3 absolute right-0 top-0"
                    >
                        Send
